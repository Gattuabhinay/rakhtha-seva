...
## Live path
1. Home — Theme 2 badge + stack (OpenRouter / Twilio / WhatsApp)
...
6. **Alert Command Center** → tap **WhatsApp + call my phone**
   - WhatsApp opens for top match (AI template)
   - Toggle **English / हिन्दी** → Twilio calls **your registered phone** (Profile)
   - Add your number in Profile + Twilio Verified Caller IDs first
...
- **Admin only:** Twilio voice call (your registered phone)  
